...
?>
<div class="<?php echo $args['classes']; ?>">
	...
	<div class="<?php echo $filter['className']; ?>">
		<form action="<?php echo $args['action']; ?>" method="get">
			<div class="form-group">
				<label><?php echo $filter['title']; ?></label>
				<select class="form-control" name="<?php echo $filter['taxonomy']; ?>"
					title="<?php echo $filter['title']; ?>" id="<?php echo $filter['taxonomy']; ?>"
			...
			<?php
                $series = explode(',', $args['series_filter']);
            
                if (isset($args['series_filter']) && '' !== $args['series_filter'] && $series) :
                    if ($series > 1) :
			...
			<?php
                ...
                $service_types = explode(',', $args['service_type_filter']);
                
                if (isset($args['service_type_filter']) && '' !== $args['service_type_filter'] && $service_types) :
                    if ($service_types > 1) :
