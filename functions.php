...
{
    wp_enqueue_style('stylesheet', get_template_directory_uri() . '/style.min.css', false, '3.0.0', 'all');
}
...
function ccc_theme_scripts()
{
    ...
    // Load Contrllers
    // wp_enqueue_script('visit-controller', get_template_directory_uri() . '/app/controllers/VisitController.js', false, '3.0.0', 'all');
