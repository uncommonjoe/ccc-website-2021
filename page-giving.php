...
<div class="page-content margin-xxl-top margin-xxl-bottom">
    <div class="container">
        ...
        <?php if(get_field('giving_cta') == 'button'): ?>
        <div class="row margin-xl-top delay-1">
            <div class="col-12 text-center">
                <a class="btn btn-lg <?php echo get_field('giving_button_color'); ?> margin-md-right"
                    href="<?php echo get_field('giving_button_url'); ?>">
                    <?php echo get_field('giving_button_title'); ?>
                </a>
            </div>
        </div>
        <?php endif; // button ?>

        <?php if(get_field('giving_cta') == 'code'): ?>
        <div class="row margin-xl-top delay-1">
            <div class="col-12">

                <?php echo get_field('giving_textcode'); ?>
